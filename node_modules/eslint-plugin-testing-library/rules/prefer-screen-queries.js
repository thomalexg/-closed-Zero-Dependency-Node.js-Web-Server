...
var ALLOWED_RENDER_PROPERTIES_FOR_DESTRUCTURING = ['container', 'baseElement'];
...
function usesContainerOrBaseElement(node) {
    ...
    return node_utils_1.isObjectExpression(secondArgument) && secondArgument.properties.some(function (property) { return node_utils_1.isProperty(property) && node_utils_1.isIdentifier(property.key) && ALLOWED_RENDER_PROPERTIES_FOR_DESTRUCTURING.includes(property.key.name); });
}
    ...
    create: function (context) {
        ...
        return _a = {
                VariableDeclarator: function (node) {
                    ...
                    var usesRenderOptions = node.init.callee.name === 'render' && usesContainerOrBaseElement(node.init);
